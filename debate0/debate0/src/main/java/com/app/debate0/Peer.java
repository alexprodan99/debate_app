...
import com.app.debate0.console.ConsoleInput;
...
public class Peer {
    ...
    private static final int PORT1 = 5050; // server -> listener
    private static final int PORT2 = 6060; // citeste + scrie
                ...
                if(token != null) { // are token
                    ...
                    if (userInput == null) {
                        ...
                        for(int i = 0; i < topics.length; i++) {
                            if(!topics[i].equals("harry_potter") && !topics[i].equals("sport")) {
                                topicNotFound = true;
                                break;
                            }
                        }
