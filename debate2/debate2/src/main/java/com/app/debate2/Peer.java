...
import com.app.debate2.console.ConsoleInput;
...
public class Peer {
    ...
    private static final int PORT1 = 7070; // server -> receiver
    private static final int PORT2 = 5050; // transmitter
                ...
                if (token != null) { // are token
                    ...
                    if (userInput == null) {
                        ...
                        for(int i = 0; i < topics.length; i++) {
                            if(!topics[i].equals("harry_potter") && !topics[i].equals("cooking")) {
                                topicNotFound = true;
                                break;
                            }
                        }
                            ...
                            for (int i = 0; i < size; i++) {
                                ...
                                switch (topic) {
                                    case "cooking":
                                        ...
                                        break;
                                    case "harry_potter":
                                        publisher.publishHarryPotterMessage(message);
                                        break;
                                    default:
